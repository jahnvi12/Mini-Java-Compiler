 ...
 */
public class MapLabelsToLine<R, A> implements GJVisitor<R, A> {
	//
...
//		for (String key : labelToLineNo.keySet())
//			System.out.println(key + " " + labelToLineNo.get(key));
		return (R) labelToLineNo;
	}
