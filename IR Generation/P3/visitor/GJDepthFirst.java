...
public class GJDepthFirst<R, A> implements GJVisitor<R, A> {
	...
	public R visit(Goal n, A argu) {
		...
		// for (String class_ : objectTable.keySet()) {
		// ObjectTable t = objectTable.get(class_); for (String m : t.vTable.keySet()) {
		// System.out.println(m + " " + t.vTable.get(m).className); } }
		return (R) Table;
	}
	...
	public R visit(ClassExtendsDeclaration n, A argu) {
		...
		if (Table.containsKey(name)) {
			if (debug)
				System.out.println(name + " Dup ext class decl");
	...
	public R visit(MethodDeclaration n, A argu) {
		...
		if (curTable.method.containsKey(mName)) {
			if (debug)
				System.out.println(mName + " method redecl");
			System.out.println("Type error");
			System.exit(0);
		}
